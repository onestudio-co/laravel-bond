...
return [
    ...
    'exists' => 'هذا :attribute غير موجود مسبقاً.',
    ...
    'payment_failed_wrong_expiry_date' => 'تم رفض العملية، يرجى التأكد من تاريخ الإنتهاء',

    'payment_failed_card_blocked' => 'تم رفض العملية من قبل البنك الخاص بك',

    'payment_failed_user_account_unknown' => 'تم رفض العملية لعدم التعرف على رقم الحساب',

    'payment_failed_insufficient_funds' => 'لا يوجد رصيد كافٍ لديك',

    'payment_failed_invalid_credit_card' => 'نأسف، يوجد خطأ في معلومات البنك المدخلة',

    'payment_failed_invalid_month' => 'نأسف، الشهر المدخل غير صحيح',

    'payment_failed_request_contains_no_month' => 'يرجى اختيار الشهر',

    'payment_failed_request_contains_no_year' => 'يرجى اختيار السنة',

    'payment_failed_invalid_year' => 'نأسف، السنة التي قمت باخيارها غير صحيحة',

    'payment_failed_card_expired' => 'نأسف، البطاقة المدخلة منتهية',

    'payment_failed_card_not_yet_valid' => 'نأسف، البطاقة المدخلة غير فعّالة',

    'payment_failed_invalid_expiration_date_format' => 'يرجى التاكد من صيغة تاريخ الانتهاء',

    'payment_failed_exceeding_account_balance' => 'نأسف، العملية تتجاوز الرصيد المتاح لديك',

    'payment_failed_general_error' => 'فشلت عملية الدفع، يرجى المحاولة مرة أخرى.',

    'checkout_failed' => 'فشلت عملية انشاء الطلب، يرجى المحاولة مرة أخرى.',
